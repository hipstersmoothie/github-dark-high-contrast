...
- fix inactive selection background ([@hipstersmoothie](https://github.com/hipstersmoothie))
...
# v0.0.12 (Mon Dec 21 2020)

#### ⚠️ Pushed to `master`

- fix match background ([@hipstersmoothie](https://github.com/hipstersmoothie))
